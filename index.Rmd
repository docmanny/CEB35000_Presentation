...
```{r, message=F, echo=F, fig.width = 14, fig.height = 6, fig.align = 'center'}
...
hx <- lapply(a, function(a){dstable(x,alpha = a, beta = 0, gamma = 1, delta=0)})
colors <- c("red", "blue", "darkgreen", "black")
plot(x, dstable(x, alpha = 0.5, beta = 0, gamma = 1, delta=0), type="l", col=colors[4], lty=2, xlab="X", ylab="Density", main="Increasing stability parameter increases probability density at the mean")
for (s in seq_along(hx)) {
